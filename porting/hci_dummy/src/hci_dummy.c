...
int
dummy_hci_transport_send_acl_to_host(uint8_t *buf, uint16_t size)
{
...
int
dummy_hci_transport_send_evt_to_host(uint8_t *buf, uint8_t size)
{
    uint8_t *trans_buf;
    int rc;
