...
#ifndef MYNEWT_VAL_ADC_0_INTERRUPT_PRIORITY
#define MYNEWT_VAL_ADC_0_INTERRUPT_PRIORITY (NRFX_SAADC_CONFIG_IRQ_PRIORITY)
#endif

#ifndef MYNEWT_VAL_ADC_0_OVERSAMPLE
#define MYNEWT_VAL_ADC_0_OVERSAMPLE (NRFX_SAADC_CONFIG_OVERSAMPLE)
#endif

#ifndef MYNEWT_VAL_ADC_0_RESOLUTION
#define MYNEWT_VAL_ADC_0_RESOLUTION (NRFX_SAADC_CONFIG_RESOLUTION)
#endif
...
/* Overridden by targets/libnimble (defined by nimble/controller) */
...
#define MYNEWT_VAL_BLE_PUBLIC_DEV_ADDR ((uint8_t[6]){0xcc, 0x00, 0x00, 0xc0, 0xde, 0xc0})
#endif
